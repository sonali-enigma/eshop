...
class Product (models.Model):
    ...
    yellow=models.BooleanField(default=False,null=True,blank=True)
    ...
    image1=models.ImageField(upload_to='images/',default=True,null=True,blank=True)
    image2=models.ImageField(upload_to='images/',default=True,null=True,blank=True)
    image3=models.ImageField(upload_to='images/',default=True,null=True,blank=True)
    image4=models.ImageField(upload_to='images/',default=True,null=True,blank=True)
    image5=models.ImageField(upload_to='images/',default=True,null=True,blank=True)
