    ...
    if(request.method=='POST'):
        try:
            ...
            if (request.POST.get('pink') == "1"):
                p.stock = False
            if (request.POST.get('yellow') == "2"):
                 p.yellow = True
            if (request.POST.get('yellow') == "1"):
                p.stock = False
            ...
            if (request.POST.get('xl') == "1"):
                p.l = False
            p.image1=request.FILES.get('img1')
            p.image2=request.FILES.get('img2')
            p.image3=request.FILES.get('img3')
            p.image4=request.FILES.get('img4')
            p.image5=request.FILES.get('img5')
